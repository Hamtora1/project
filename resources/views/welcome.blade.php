...
<head>
  ...
  <title>A&E System Management</title>
  ...
  {{-- <link href="/css/ae.css" rel="stylesheet" type="text/css"> --}}
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0 pb=5"><img src="{{URL::asset('/img/logo.png')}}" alt="" class="img-fluid"><a href="index.html" class="d-inline-block fs-3">A&E System Management</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#counts"><span>สมัครงาน</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">สวัสดิการ</a></li>
              <li class="dropdown"><a href="#"><span>สมัครงาน</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="joe.html">ขั้นตอนการสมัคร</a></li>
                  <li><a href="process.html">กรอกใบสมัครออนไลน์</a></li>
          ...
          <li><a class="nav-link scrollto" href="#contact">ช่องทางติดต่อ</a></li>
        </ul>
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="100">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-store-line"></i>
            <h3><a href="">Outsourced development teams</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
        ...
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="">Outsourced software testing</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col order-first" data-aos="fade-left" data-aos-delay="100">
            <img src="{{URL::asset('/img/about1.jpg')}}" class="img-fluid" alt="" width="900">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ด้านการวางโครงสร้างระบบเครือข่าย (Network Infrastructure).</li>
              <li><i class="ri-check-double-line"></i> ระบบเครื่องแม่ข่าย (Server and Storage System).</li>
              <li><i class="ri-check-double-line"></i> ระบบกล้องวงจรปิด CCTV System ให้บริการครอบคลุมทุกภาค ศูนย์เครือข่ายบริการ กรุงเทพฯ ชลบุรี ขอนแก่น เชียงใหม่.</li>
              <li><i class="ri-check-double-line"></i> พัฒนาโปรแกรมให้เหมาะสมกับธุรกิจ (Software Development) รวมทั้งระบบ ERP เพื่อสนับสนุนการบริหารจัดการรูปแบบเฉพาะที่เหมาะสมสำหรับองค์กร.</li>
              <li><i class="ri-check-double-line"></i> ให้บริการและจำหน่ายเกี่ยวกับ เรื่องนวัตกรรมพลังงานสะอาด ที่สามารถประหยัดพลังงานช่วยโลก เช่น ระบบพลังงานแสงอาทิตย์ ฯ.</li>
    ...
    <section id="a" class="a">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("storage/img/features.jpg");' data-aos="fade-right"></div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>บริการ</h2>
          <p>สรรค์สร้างทางเลือกและบริการด้านไอทีครบวงจร โดยยึดความต้องการของลูกค้าและคุณภาพการบริการหลังการขายมาเป็นอันดับหนึ่ง ด้วยทีมงานที่มากด้วยประสบการณ์</p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class='bx bx-cog bx-flip-horizontal' ></i></div>
              <h4><a href="">ERP</a></h4>
              <p>ออกแบบและพัฒนาซอฟต์แวร์ สำหรับบริหารจัดการ ตามความความต้องการขององค์กร</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Onsite Support วิเคราะห์ ตรวจสอบ และแก้ปัญหา Network & System บริการออกแบบ ติดตั้งระบบ อินเตอร์เน็ตในอาคารต่างๆ เช่น หอพัก บริษัท โรงแรม</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">System Solution</a></h4>
              <p>ออกแบบ ติดตั้งระบบ Server & Storage สำหรับใช้งานภายในองค์กรขนาดใหญ่</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Outsourcing Solution Service</a></h4>
              <p>ให้บริการดูแลระบบเครือข่ายและอุปกรณ์ไอที ตามสาขาลูกค้าแบบ Outsource Service ให้คำปรึกษาและบริการที่รวดเร็วและแก้ไขปัญหาอย่างมืออาชีพ</p>
            </div>
          </div>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div>
          <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.9583205535005!2d99.03442717587103!3d18.75539866195768!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30da2f337b3930db%3A0x7e1aaf52c2ea3b97!2sA%26E%20System%20Management!5e0!3m2!1sth!2sth!4v1685527448590!5m2!1sth!2sth" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" allowfullscreen></iframe>
        </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>ที่อยู่:</h4>
                <p>business center 2 188/26 Chiangmail ตำบล ไชยสถาน อำเภอ สารภี เชียงใหม่ 50140</p>
              </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>A&E System Management</h3>
              <p>
                business center 2 188/26 Chiangmail <br>
                ตำบล ไชยสถาน อำเภอ สารภี เชียงใหม่ 50140<br><br>
                <strong>เบอร์โทรติดต่อ:</strong> 0934797000<br>
                <strong>อีเมล:</strong> info@example.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>A&E SYSTEM MANAGEMENT</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <script src="{{asset('storagejs/main.js')}}"></script>
